...
//		WebElement Initial_Sign_Btn_15;
	...
	public void Credit_Application_Tab() throws InterruptedException
	{
		...
		F_Name.clear();
		Thread.sleep(1000);
		F_Name.sendKeys("Salman");
		Thread.sleep(1000);
		L_Name.clear();
		Thread.sleep(1000);
		L_Name.sendKeys("Testcase");
		Thread.sleep(1000);
		Email.sendKeys("salman@yopmail.com");
		Thread.sleep(1000);
		Phone.sendKeys("(945) 324-6389");
		Thread.sleep(1000);
	...
	public void Submit_Contract() throws InterruptedException
	{
		...
		improve.selectByValue("4");
		
		Thread.sleep(2000);
		Quantity_Value.sendKeys("15");
...
//		driver.findElement(By.xpath("//button[contains(text(),'Yes')]")).click();
		...
		public void Funding_Tab() throws InterruptedException, IOException
		{
			...
			Thread.sleep(2000);	
			driver.findElement(By.xpath("//span[normalize-space()='Additional scope - HVAC']")).click();
			Thread.sleep(2000);
			Quantity_Value2.sendKeys("15");
			Thread.sleep(2000);
			Cost_Value.clear();
