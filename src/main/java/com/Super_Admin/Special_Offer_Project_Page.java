...
{
	String Send_NTP = "https://test.homerunportal.com/crons/sendProjectNtp/";
	String Get_msg = "http://test.homerunportal.com/crons/getMessagesFromActiveQueue";
	String Invoice = "https://test.homerunportal.com/crons/generateFundingInvoice/";
	...
	public void View_UNS_Project() throws InterruptedException
	{
		...
		// Add First Contributor ------>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>
				...
				Email_of_secnd_applicant.sendKeys("pkt1@yopmail.com");
				Thread.sleep(1000);
				Phone_No_of_secnd_applicant.sendKeys("974) 724-6119");
				Thread.sleep(1000);
				Contributor.click();
				Thread.sleep(1000);
	...
	public void Submit_SO_Contract() throws InterruptedException
	{
		...
		js2.executeScript("window.scrollBy(0,-550)", "");
			...
			improve.selectByValue("93");
			
			Thread.sleep(2000);
			Quantity_Value.sendKeys("11");
			
			Thread.sleep(2000);
			Validate_Btn.click();
			Thread.sleep(3000);
			
			String actualString = driver.findElement(By.xpath("//div[@id='payment-limit-exceed-uns']//span")).getText();
			...
			Validate_Btn.click();
			Thread.sleep(3000);	
			String actualString1 = driver.findElement(By.xpath("//div[@id='assessment-approve-uns']//span")).getText();
